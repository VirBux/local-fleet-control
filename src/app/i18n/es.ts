...
export const es: Messages = {
  ...
  'device.openCover': 'Subir',
  'device.closeCover': 'Bajar',
  'device.stopCover': 'Parar',

  'cover.open': 'Abierta',
  'cover.closed': 'Cerrada',
  'cover.opening': 'Subiendo …',
  'cover.closing': 'Bajando …',
  'cover.stopped': 'Detenida',
  'cover.calibrating': 'Calibrando …',
  'cover.unknown': 'Desconocido',
